...
public class Knapsack {
    ...
    public void keepOnlyItemsWith(int maxItemWeightInGrammes) {
        ...
        {
            if(sack.get(i) != null && sack.get(i).getWeightInGrammes() >  maxItemWeightInGrammes)
            {   
                sack.remove(i);
            }
        }
    ...
    public int totalWeightInGrammes() {
        ...
        if(totalWeight <= 0)
        {
            for(int i = 0; i < sack.size(); i++)
            {
                if(sack.get(i) != null)
                {
                    totalWeight = totalWeight + sack.get(i).getWeightInGrammes();
                }
            }
        }
    ...
    public double averageWeightInGrammes() {
        double avgWeight = 0;
        double totalItems = (double) this.numberOfItems();
        
        if(this.numberOfItems() > 0)
        {
            avgWeight = this.totalWeightInGrammes() / totalItems;
            return avgWeight;
        }
    ...
    public Item greatestItem() {
        ...
        while(count != 0 && this.numberOfItems() > 0)
        {
            if(sack.get(j) != null)
            {
                greatest = sack.get(j);
        ...
        if(this.numberOfItems() > 0)
        {
            for(int i = 0; i < sack.size(); i++)
            {
                if(sack.get(i) != null)
                {
                    if(sack.get(i).compareTo(greatest) == 1)
                    {
                        greatest = sack.get(i);
                    }
                }
    ...
    public String toString() {
        ...
        for(int i = 0; i < sack.size(); i++)
        {
            if(sack.get(i) != null )
            {
                items = items.concat(sack.get(i).toString() + ", ");
            }
        }
    ...
    public static Knapsack heaviestKnapsack(Knapsack[] knapsacks) {
        ...
        heaviest = knapsacks[0];
        
        
        for(int i = 0; i < knapsacks.length ; i++)
        {
            if(knapsacks[i].totalWeightInGrammes() > heaviest.totalWeightInGrammes())
            {
                heaviest = knapsacks[i];
            }
        }
